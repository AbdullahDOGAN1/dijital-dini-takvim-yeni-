...
class _FavoritesScreenState extends State<FavoritesScreen> {
  ...
  Future<void> _loadFavorites() async {
    try {
      ...
      print('DEBUG FavoritesScreen: Raw favorites count: ${allFavorites.length}');
      ...
      print('DEBUG FavoritesScreen: Grouped favorites keys: ${favorites.keys.toList()}');
      ...
      print('DEBUG FavoritesScreen: State updated, _groupedFavorites: $_groupedFavorites');
    } catch (e) {
  ...
  Widget _buildExpansionTile(String type, List<Map<String, dynamic>> favorites) {
    return Container(
      ...
      child: Card(
        ...
        child: ExpansionTile(
          ...
          children: favorites.map((favorite) => _buildFavoriteCard(favorite)).toList(),
        ),
      ),
    );
  }
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              if (favorite['content_source'] != null && favorite['content_source'].isNotEmpty) ...[
                const SizedBox(height: 8),
                Container(
  ...
  Widget build(BuildContext context) {
    ...
    print('DEBUG FavoritesScreen: _groupedFavorites.isEmpty = ${_groupedFavorites.isEmpty}');
    print('DEBUG FavoritesScreen: _totalFavoritesCount = $_totalFavoritesCount');
              ...
              onPressed: () {
                showDialog(
                  ...
                  builder: (context) => AlertDialog(
                    ...
                    content: Text('Tüm favorilerinizi silmek istediğinizden emin misiniz?'),
                    actions: [
                      TextButton(
