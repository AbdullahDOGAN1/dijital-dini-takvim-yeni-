...
class CalendarService {
  ...
  static Future<List<DailyContentModel>> loadCalendarData() async {
    try {
      ...
      final String jsonString = await rootBundle.loadString('assets/data/sample_calendar_data.json');
      ...
      final List<DailyContentModel> calendarData = jsonList
          .map((json) => DailyContentModel.fromJson(json as Map<String, dynamic>))
          .toList();
