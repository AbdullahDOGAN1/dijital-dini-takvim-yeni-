...
// Bu widget artık kullanılmıyor - main.dart'ta yeni _PageContent widget'ı var
// Gelecekte gerekirse buradan erişilebilir

class DailyPageWidget extends StatelessWidget {
  final DailyContentModel content;
  final bool isBack;

  const DailyPageWidget({
    super.key,
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: const Color(0xFFF5F5DC), // Vintage paper color
      ...
      child: ClipRRect(
        ...
        child: Container(
          ...
          child: Padding(
            ...
            child: isBack ? _buildBackPage() : _buildFrontPage(),
          ),
        ),
      ),
    );
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: const Color(
          0xFFF5F3ED,
        ), // Slightly different vintage paper color for back
        borderRadius: BorderRadius.circular(10),
        boxShadow: [
          BoxShadow(
            color: Colors.black.withOpacity(0.15),
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  Row(
                    children: [
                      Icon(Icons.menu_book, color: Colors.brown[700], size: 22),
            ...
            Container(
              ...
              child: Row(
                children: [
                  Icon(Icons.swipe_up, color: Colors.orange[600], size: 16),
                  const SizedBox(width: 8),
                  Expanded(
                    child: Text(
